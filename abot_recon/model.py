...
def build_released_network(
    *,
    ...
    infer_mode: str = "full",
    use_chunk_flex_attention: bool = False,
    use_chunk_flex_compile: bool = False,
) -> torch.nn.Module:
    """Build the checkpoint-exact network shared by inference and fine-tuning."""
    ...
    return ABotReconNetwork(
        ...
        paged_max_total_frames=max_frames,
        ...
        use_chunk_flex_attention=use_chunk_flex_attention,
        use_chunk_flex_compile=use_chunk_flex_compile,
...
class ReleasedABotReconModel(torch.nn.Module):
    ...
    def __init__(self, config: InferenceConfig):
        ...
        with device, torch.no_grad():
            self.network = build_released_network(
