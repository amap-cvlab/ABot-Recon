...
# Prefer the repository-local CUDA operator when it is available. Formal
# evaluation scripts require this backend explicitly; PyTorch remains the
...
if RoPE2D is None:
    ...
    class RoPE2D(torch.nn.Module):
        ...
        def forward(self, tokens, positions):
            ...
            if positions.shape[1] != tokens.shape[2]:
                raise RuntimeError(
