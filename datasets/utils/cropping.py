...
def resize_image_depth_and_intrinsic(
    ...
    # Per-axis scale (sx may differ from sy when height is snapped to patch multiple).
    scale_x = float(output_resolution[0] / input_resolution[0])
    scale_y = float(output_resolution[1] / input_resolution[1])
